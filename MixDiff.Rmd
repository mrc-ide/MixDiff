...
* Essential
1. Allow different sd for proposal for different delay means and sds - Anne
...
6. Try to speed up DistrGamma by vectorising lines (Anne)
7. Have an option to use exact DistrGamma or approximate which is faster (Anne)
...
4. do we indeed want to update zeta after each D_i move? maybe not useful? (Anne)
