                    ...
                    range_dates=NULL)
{
  ...
  ## sample_delay <- discr_gamma_sample(length(i), shape=param_delay[1], scale=param_delay[2])
  ...
  ## prob_proposing_new_value <- DiscrGamma(sample_delay, shape=param_delay[1], scale=param_delay[2], log = TRUE) # make sure it's the log
  ## prob_proposing_curr_value <- DiscrGamma(curr_delay, shape=param_delay[1], scale=param_delay[2], log = TRUE) # make sure it's the log
